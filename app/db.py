# Gestione connessione database (02_DB_e_Repository.md)
...
def get_db():
    """
    Restituisce la connessione al database per la richiesta
    'g' è uno zaino temporaneo di Flask
    Se la connessione c'è già, la riuso senno la creo
    """
    if 'db' not in g:
